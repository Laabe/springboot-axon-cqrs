...
import com.cqrs.cqrs.bank.events.*;
import lombok.Data;
...
public class AccountAggregate {
    ...
    protected void on(MoneyCreditedEvent moneyCreditedEvent){
        ...
        if (this.accountBalance < 0 & (this.accountBalance + moneyCreditedEvent.creditBalance) >= 0){
            AggregateLifecycle.apply(new AccountActivatedEvent(this.id, Status.ACTIVATED));
        }

        this.accountBalance += moneyCreditedEvent.creditBalance;
    }
